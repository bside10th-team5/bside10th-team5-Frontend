    ...
    const SliderArrow = () => {
        ...
        return (
            <SliderArrowContainer>
                <button onClick={onClickUpArrow}><img src="/img/home/icon/slider/arrow/up.svg" /></button>
                ...
                <button onClick={onClickDownArrow}><img src="/img/home/icon/slider/arrow/down.svg" /></button>
            </SliderArrowContainer>
        )
    }
                            ...
                            <Wrapper>
                                ...
                                <div>
                                    <MainTitleWrapper>
                                        ...
                                        {isLoggedIn ? <div></div> : <StartButton className="subtitle-2" onClick={onClickLoginButton}>시작하기</StartButton>}
                                    </MainTitleWrapper>
                                </div>
                            </Wrapper>
