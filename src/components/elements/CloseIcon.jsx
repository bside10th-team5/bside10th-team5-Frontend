...
const CloseIcon = ({ className, color = `${GRAY900}`, width = 10, height = 10, onClick }) => {
  return (
    <svg className={className} width={width} height={height} onClick={onClick} viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
